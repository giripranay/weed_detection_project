...
if("TRUE" STREQUAL "TRUE")
  set(agribot_control_SOURCE_PREFIX /root/project_ws/src/agribot/agribot_control)
  set(agribot_control_DEVEL_PREFIX /root/project_ws/devel)
  ...
  set(agribot_control_INSTALL_PREFIX /root/project_ws/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'agribot_control' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/root/project_ws/src/agribot/agribot_control/${idir}'.  ${_report}")
    endif()
